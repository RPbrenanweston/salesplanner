...
import { PLANNER_BRAND } from '@/lib/planner/branding'

const navItems = [
  { name: 'Briefing', path: '/dashboard/briefing', icon: Sunrise },
  { name: 'Day Planner', path: '/dashboard/planner', icon: CalendarDays },
  { name: 'Activity', path: '/dashboard/activity', icon: FileText },
  { name: 'Debrief', path: '/dashboard/debrief', icon: BookOpen },
        ...
        <div className="border-t border-gray-200 dark:border-white/10 p-3">
          ...
          <div className="flex items-center justify-between gap-1">
            <button
              ...
              } px-3 py-2 rounded-lg text-gray-500 dark:text-white/40 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white transition-colors duration-150`}
            ...
            <button
              ...
              className={`flex items-center ${
                collapsed ? 'justify-center w-full' : 'justify-start'
              } px-3 py-2 rounded-lg text-gray-500 dark:text-white/40 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-red-600 dark:hover:text-red-alert transition-colors duration-150`}
            ...
            {!collapsed && (
              <button
                ...
                className="p-2 rounded-lg text-gray-500 dark:text-white/40 hover:bg-gray-100 dark:hover:bg-white/5"
              >
          ...
          {collapsed && (
            <button
              ...
              className="w-full mt-1 p-2 rounded-lg text-gray-500 dark:text-white/40 hover:bg-gray-100 dark:hover:bg-white/5 flex items-center justify-center"
            >
