 ...
 * @intent Central export point for @/components/admin UI package with zero external dependencies
 ...
 * @prompt Keep imports named-only (no default export) for clarity. Document portability constraints if publishing to npm. Update re-export shims in @/components/admin if types change.
 */

// @/components/admin — Portable admin UI package
// Zero external dependencies — safe to copy to any repo.
