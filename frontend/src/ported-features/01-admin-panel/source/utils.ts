 ...
 * @prompt Match pattern used in @/components/ui. If custom CSS classes conflict with Tailwind, add to twMerge safelist or rename classes. Monitor bundle size impact of regex matching.
 */
